...
Taktiež pracujem na návrhoch architektúr, ktoré využívajú Public Cloud AWS, Azure a GCP, alebo privátny cloud (VMware, [OpenStack](https://www.openstack.or), [Kubernetes](https://kubernetes.io). Návrhy migrácií existujúcich infraštruktúr do cloudu, multi-cloud riešenia, správa bezpečnosti a ochrana prístupov ku cloud systémom spolu s prevádzkou, údržbou a riešením vzniknutých problémov.

Taktiež vyrábam, predávam a držím podporu na [OPNsense](https://opnsense.org)/pfSense base firewall. Na Slovensku sa mi podarilo predať už niekoľko stoviek firewallov a zaťial sú všetci zákazníci spokojný vďaka modularite (packages), otvorenému kódu a podpore v lokálnom jazyku.
